...
```bash
./gradlew :auth-service:test :job-service:test :application-service:test :admin-service:test :notification-service:test
```
#   J o b P o r t a l G r a d l e  
 